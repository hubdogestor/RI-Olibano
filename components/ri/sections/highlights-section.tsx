...
export default function HighlightsSection({ highlights }: HighlightsSectionProps) {
  ...
  return (
    ...
    >
      <motion.div variants={containerVariantsStagger.stagger_0_12} initial="hidden" animate="visible" className="max-w-5xl">
        <motion.h2
        ...
        <motion.p variants={fadeInYEaseOut} className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 md:mb-12">
