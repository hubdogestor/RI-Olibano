...
export default function TractionSection({ traction }: TractionSectionProps) {
  ...
  return (
    <section aria-label="Tração e validação de mercado" className="h-full flex flex-col justify-center p-12 bg-gradient-to-br from-white via-gray-50 to-[#69683B]/3">
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-5xl">
        ...
        <div className="mb-16">
          ...
          <div className="relative">
            <div className="absolute left-10 right-10 top-16 hidden h-0.5 bg-gradient-to-r from-[#C88715] to-transparent lg:block" aria-hidden="true" />
            <div
              role="region"
              aria-label="Timeline scrollável de tração e marcos (use as setas do teclado para navegar)"
              className="flex snap-x snap-mandatory gap-6 overflow-x-auto pb-6 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#C88715]/40"
            >
